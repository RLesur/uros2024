...
- Has the right to orchestrate workflows and to deploy applications in production (CI/CD)
...
- some statisticians (mostly managers) saw R a new statistical "tool". Focus on the product, not the process
- other statisticians (mostly the younger ones) saw R as a programming language and considered themselves as developers
