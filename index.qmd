...
- IT recognizes statisticians as "citizen developers":
  ...
  * statisticians are encouraged to apply software development best practices
...
- Has the right to orchestrate workflows and deploy applications in production (DevOps)
...
- Statisticians must be trained in computer science
